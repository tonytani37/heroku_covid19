...
ax1.vlines(ymin=min(df_a['感染者数'].tail(days)),ymax=max(df_a['感染者数'].tail(days)),x=dt.datetime(2021,1,8),color='red',linestyles='dashed')
ax1.vlines(ymin=min(df_a['感染者数'].tail(days)),ymax=max(df_a['感染者数'].tail(days)),x=dt.datetime(2021,1,22),color='green',linestyles='dashed')

ax1.vlines(ymin=min(df_a['感染者数'].tail(days)),ymax=max(df_a['感染者数'].tail(days)),x=dt.datetime(2020,4,7),color='red',linestyles='dashed')
ax1.vlines(ymin=min(df_a['感染者数'].tail(days)),ymax=max(df_a['感染者数'].tail(days)),x=dt.datetime(2020,4,21),color='green',linestyles='dashed')

ax1.vlines(ymin=min(df_a['感染者数'].tail(days)),ymax=max(df_a['感染者数'].tail(days)),x=dt.datetime(2020,10,1),color='gray',linestyles='dashed')
ax1.vlines(ymin=min(df_a['感染者数'].tail(days)),ymax=max(df_a['感染者数'].tail(days)),x=dt.datetime(2020,7,22),color='gray',linestyles='dashed')
...
ax1.vlines(ymin=min(df_a['重症者数'].tail(days)),ymax=max(df_a['重症者数'].tail(days)),x=dt.datetime(2021,1,8),color='red',linestyles='dashed')
ax1.vlines(ymin=min(df_a['重症者数'].tail(days)),ymax=max(df_a['重症者数'].tail(days)),x=dt.datetime(2021,1,22),color='green',linestyles='dashed')

ax1.vlines(ymin=min(df_a['重症者数'].tail(days)),ymax=max(df_a['重症者数'].tail(days)),x=dt.datetime(2020,4,7),color='red',linestyles='dashed')
ax1.vlines(ymin=min(df_a['重症者数'].tail(days)),ymax=max(df_a['重症者数'].tail(days)),x=dt.datetime(2020,4,21),color='green',linestyles='dashed')

ax1.vlines(ymin=min(df_a['重症者数'].tail(days)),ymax=max(df_a['重症者数'].tail(days)),x=dt.datetime(2020,10,1),color='gray',linestyles='dashed')
ax1.vlines(ymin=min(df_a['重症者数'].tail(days)),ymax=max(df_a['重症者数'].tail(days)),x=dt.datetime(2020,7,22),color='gray',linestyles='dashed')
